...
Point(1) = {-0.3, 0.0, 0.0, lc};
Point(2) = {1.3, 0.0, 0.0, lc};
Point(3) = {1.3, 0.3, 0.0, lc};
Point(4) = {-0.3, 0.3, 0.0, lc};
...
Point(100) = {0.50, -0.30, 0.0, lc};
Point(101) = {0.65, -0.30, 0.0, lc};
Point(102) = {0.35, -0.30, 0.0, lc};
