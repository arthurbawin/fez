...
#ifndef dealii_mapping_fe_field_hp2_h
...
/**
 * The MappingFEFieldHp2 is a generalization of the MappingQEulerian class, for
 ...
 *    MappingFEFieldHp2<dim,spacedim> map(dhq, eulerq, mask);
 * @endcode
 */
template <int dim, int spacedim = dim, typename VectorType = Vector<double>>
class MappingFEFieldHp2 : public Mapping<dim, spacedim>
{
public:
  /**
...
protected:
  ...
  std::vector<ObserverPointer<const VectorType,
                              MappingFEFieldHp2<dim, spacedim, VectorType>>>
    euler_vector;
...
private:
  ...
  friend class MappingFEFieldHp2;
};
