...
void TimeHandler::update_parameters_after_restart(const Parameters::TimeIntegration &new_params)
{
...
double TimeHandler::compute_scaled_ratio(
...
double TimeHandler::propose_next_dt(const double       dt,
                                            const double       R,
